...
#
# Script generated by Vivado on Sat Oct 07 12:31:01 -0500 2023
...
# script info
echo -e "cpu.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L microblaze_v11_0_11 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L lmb_v10_v3_0_12 -L lmb_bram_if_cntlr_v4_0_22 -L blk_mem_gen_v8_4_6 -L iomodule_v3_1_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpu xil_defaultlib.cpu xil_defaultlib.glbl -log elaborate.log
}
