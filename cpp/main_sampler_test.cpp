...
int main() {
   ...
   const uint8_t SSEG_90[] = {0xff,0xff,0b1000000,0b0011000,0xff,0xff,0xff,0xff};
   const uint8_t SSEG_180[] = {0xff,0b1000000,0b0000000,0b1111001,0xff,0xff,0xff,0xff};
   const uint8_t SSEG_270[] = {0xff,0b1000000,0b1011000,0b0100100,0xff,0xff,0xff,0xff};
   sseg.set_dp(0x00);
   int8_t xraw, yraw, zraw;
   float x, y, z;
   spi_p->set_freq(400000);
